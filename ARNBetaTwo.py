...
st.image("https://github.com/FoxGodTodd/KineticPlanner/raw/main/ARNbanner.png")
...
greenlist = st.multiselect(
            ...
            ('BLACKFRIARS STN','VICTORIA STN','EUSTON STN',"KING'S CROSS STN",
				'LIVERPOOL STREET STN','ST PANCRAS STN', 'WATERLOO STN',
				'BLUEWATER CENTRE S/C - DARTFORD','WESTFIELD STRATFORD CITY',
				'WESTFIELD LONDON','ATRIA WATFORD S/C - WATFORD',
			 	'LAKESIDE S/C - THURROCK','SOUTHSIDE S/C - WANDSWORTH',
				'CITY THAMESLINK STN','CLAPHAM JUNCTION STN',
				'ELEPHANT AND CASTLE STN','HERNE HILL STN',
				'MILL HILL BROADWAY STN','OLD STREET STN',
			 	'LIVERPOOL STREET STN','BENTALL CENTRE',
			 	'CANNON STREET STN', 'CHARRING CROSS STN',
			 	'WATERLOO EAST STN','LONDON BRIDGE STN',
				'ST ALBANS STN','STREATHAM COMMON STN',
				'STREATHAM HILL STN','STREATHAM STN'),
				)
